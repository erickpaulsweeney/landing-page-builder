                        ...
                        <form onSubmit={handleSubmit} className="form-proper">
                            ...
                            <div className="container-pictures">
                                <input type="radio" id="pencil" name="picture" value={pencil}
                                    ...
                                    checked={picture === pencil} />
                                <img className="option pencil-img" src={pencil} alt="Pencil" onClick={() => setPicture(pencil)} />
                                <input type="radio" id="wavy" name="picture" value={wavy}
                                    ...
                                    checked={picture === wavy} />
                                <img className="option wavy-img" src={wavy} alt="Wavy Blue" onClick={() => setPicture(wavy)} />
                            </div>
